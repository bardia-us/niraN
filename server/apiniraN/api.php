...
$windowsUsername = $schemaVersion === 2
    ...
    : '';
$windowsVersion = valid_text($payload['windows_version'] ?? null, 160);
...
if ($installationId === null ||
    ...
    $windowsVersion === null || $appVersion === null ||
...
try {
    ...
    $identityUpdates = $schemaVersion === 2
    ...
    respond(200, ['ok' => true, 'schema_version' => 2]);
